...
public class MainActivity extends AppCompatActivity
    ...
    private HeaderThread headerThread;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case MsgInfo.INFO_MSG:
                    ...
                    Toast.makeText(MainActivity.this, "USER_Info.user_progress:" + USER_Info.user_progress, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(MainActivity.this, USER_Info.user_id + " " + USER_Info.user_name + " " + USER_Info.user_class + " " + USER_Info.user_xf + " " + USER_Info.user_total_xf, Toast.LENGTH_SHORT).show();
//                    Log.d("MainActivity", text);
    ...
    public class HeaderThread extends Thread{
        ...
        public void run() {
            ...
            Bitmap bitmap = null;
            try {
                conn = (HttpURLConnection) new URL(Head_url).openConnection();
